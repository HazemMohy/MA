...
train_loader = DataLoader(train_ds, batch_size=1, shuffle=True, num_workers=4)#, pin_memory=pin_memory) #test --> batch_size = 2
...
max_epochs = 100 #test --> 500 or 1000 (I want the real one to be 2000 but I get always a CUDA_OutOfMemory_Error)
