...
path_prediction = "/lustre/groups/iterm/Hazem/MA/Runs/run_28743063__DiceCELoss_None_ECXLUDE_ENCODER/Model_outputs_nifti" # Path to prediction
path_result     = "/lustre/groups/iterm/Hazem/MA/Runs/run_28743063__DiceCELoss_None_ECXLUDE_ENCODER/Model_outputs_nifti" # Path where result csv is saved to
